...
def talker():
    ...
    while detection:
        ...
        elif k == ord('s'):  # s key to publish first bboxes and start looping
            if first_frame == 1:  #se effettivamente sono nel primo frame
        ...
        elif k == ord('r'):  # p key to publish bboxes
            first_frame = 1
            list_bboxes = []
            pr = []
        elif k != 255:
